...
@Component({
  selector: 'app-NewErrPage',
  templateUrl: './NewErrPage.component.html',
  styleUrls: ['./NewErrPage.component.scss']
})
export class NewErrPageComponent implements OnInit ,OnDestroy{
