...
export class MainDashboardComponent implements OnInit {
   ...
   * Apex chart
   */
   public EURChartOptions: any = {};
   public WURordersChartOptions: any = {};
  ...
  totalWaterConsumption: any;
  factoryName: any;
  constructor(private _AppServiceService:AppServiceService) { }
  ngOnInit(): void {

    this.gitMainDashboard(1,0);
    this.GetMainDashboardSLE()
    this.GetMainDashboardConsumption();

  }
  public DrilDownChartOptions(Name:any,factory:any,line:any)
  {


    Highcharts.chart('DrilDownChart', {
  ...
  private RadarChart(sleSeries:any,timeSeries:any)
  {
  ...
  gitMainDashboard(time:any,id:any ){
    this._AppServiceService.MainDashboard(time).subscribe((data:any)=>{
      console.log(data)
      Highcharts.setOptions({
        ...
        this.DrilDownChartOptions("Packets",data[0].factoryPackets,data[0].linePackets)
      if(id == 0){
        ...
        this.DrilDownChartOptions("Bottles",data[0].factoryBottles,data[0].lineBottles)

      }
      else if(id == 2){
        this.DrilDownChartOptions("Pallets",data[0].factoryPallets,data[0].linePallets)

      }
    })
  }
  // filterProduction(){
  //   this.gitMainDashboard(1,this.ProductFilterid)
  // }
  GetMainDashboardConsumption(){
    this._AppServiceService.GetMainDashboardConsumption().subscribe((data:any)=> {
      this.EURChartOptions = ConsumptionChartOptions(this.obj,data[0].energySeries,data[0].energyTimeSeries);
      this.WURordersChartOptions = ConsumptionChartOptions(this.obj,data[1].waterSeries,data[1].waterTimeSeries);
      this.totalEnergyConsumption = data[0].totalEnergyConsumption
      this.totalWaterConsumption = data[1].totalWaterConsumption

    })
  }
  GetMainDashboardSLE(factory:any = '',line:any = -1){
    this._AppServiceService.GetMainDashboardSLE(factory,line).subscribe((data:any)=>{
      console.log(data)
      // this.RadarChartOptions(data[0].sleSeries,data[0].timeSeries)
      this.RadarChartOptions = getRadarChartOptions(this.obj,data[0].sleSeries,data[0].timeSeries)
    })
  }
}
  // * Customerse chart options
  // */
 function ConsumptionChartOptions(obj: any,energySeries:any,energyTimeSeries:any) {
   return {
     series: [{
       name: '',
       data: energySeries
 ...
 function getRadarChartOptions(obj: any,sleSeries:any,timeSeries:any) {
  return {
    series: [
      {
        name: 'SLE',
  ...
  */
 function getOrdersChartOptions(obj: any,energySeries:any,energyTimeSeries:any) {
   return {
     series: [{
       name: '',
       data: energySeries
